Fulgur = function(selector, context, options) {
    ...
    if (selector.constructor === String) {
        ...
        if (context._DOMElement) {
            ...
            domElements = context.querySelectorAll(selector)
        }
...
Fulgur.Element.prototype.on = function(identifier, selector, callback) {
    ...
    this._listeners[identifier].push({
        type: type,
        selector: selector,
        callback: _callback
    });
...
Fulgur.http.Handler = function(parent) {
    parent = parent || {};
    this.onload = parent.onload || function() {};
    this.onsuccess = parent.onsuccess || function() {};
    this.onerror = parent.onerror || function() {};
    this.ondownloadprogress = parent.ondownloadprogress || function() {};
    this.onuploadprogress = parent.onuploadprogress || function() {};
    this.load = function(callback) {
        this.onload = callback;
        return this;
    };
